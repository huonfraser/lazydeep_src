...
class Preprocess_PLS():

  def __init__(self, class_name="target",n_components=5):
    self.class_name = class_name
    self.scaler = PLSRegression(n_components)

  def fit(self, data,y=None):
    self.scaler.fit(data,y)
    #print(self.scaler.x_weights_)
    #print(self.scaler.y_weights_)
